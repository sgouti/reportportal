...
COPY service-auto-analyzer/requirements/ ./requirements/
...
COPY service-auto-analyzer/app ./app
COPY service-auto-analyzer/res ./res
COPY service-auto-analyzer/VERSION ./VERSION
COPY service-auto-analyzer/Makefile ./Makefile
ARG APP_VERSION=""
